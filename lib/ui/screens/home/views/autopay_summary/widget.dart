...
class AutopaySummary extends StatefulWidget {
  @override
  _AutopaySummaryState createState() => _AutopaySummaryState();
}

class _AutopaySummaryState extends State<AutopaySummary> {
                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    SliverPadding(
                      ...
                      sliver: SliverAppBar(
                        pinned: true,
                        title: Text('Monthly Autopay Summary'),
                      ),
                    ),
                    SliverPadding(
